...
def ordenar(lista_invitados):
    lista_invidatos_ordenada = sorted(lista_invitados)
    return lista_invidatos_ordenada
# --------------------------------
...
if __name__ == '__main__':
    ...
    print('Lista de invitados ordenada:\n',lista_invidatos_ordenada)
